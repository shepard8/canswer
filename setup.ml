...
(* OASIS_START *)
(* DO NOT EDIT (digest: b9df0b5e56ca209b459f90f52097de52) *)
(*
...
let setup_t =
  {
            ...
            [
                 ...
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["FromStringParser"; "FromStringLexer"];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "canswer_core"];
                      bs_build_tools =
                   ...
                   {
                      lib_modules = ["FunDep"; "AttackGraph"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "canswer_core";
                           InternalLibrary "canswer_attackgraph"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_c_sources = [];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["CqaFO"; "Expanded"; "Collapsed"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "canswer_core";
                           InternalLibrary "canswer_attackgraph";
                           InternalLibrary "canswer_rewrite";
                           InternalLibrary "canswer_cqafo"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_c_sources = [];
                   ...
                   {
                      lib_modules =
                        ["Canswer"; "ToString"; "ToDot"; "ToLatex"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Canswer";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\246\028O\195\129\227\017|\225\248)\178\190>$\n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
